...
from leitura03 import extrair_sentencas, ler_arquivo_xml
class TestCaseFrases(unittest.TestCase):
    ...
    def test_frases_BIO(self):
        body = """
                ...
                """
        with open("data/sample.txt","r") as fd:
            answer = []
            sent = []
            for line in fd:
        ...
        sentencas_BIO = sent2BIO(sentencas)
        self.assertEqual(sentencas_BIO, answer)
